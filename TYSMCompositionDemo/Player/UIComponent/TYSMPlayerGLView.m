...
@implementation TYSMPlayerGLView {
    CGRect _layerBounds;
}
...
- (void)displayPixelBuffer:(CVPixelBufferRef)pixelBuffer
{
    ...
    CGRect vertexSamplingRect = AVMakeRectWithAspectRatioInsideRect(CGSizeMake(_backingWidth, _backingHeight), _layerBounds);
